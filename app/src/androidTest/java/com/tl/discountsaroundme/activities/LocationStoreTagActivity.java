...
public class LocationStoreTagActivity {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void locationStoreTagActivity() {
        ...
        ViewInteraction button2 = onView(
                allOf(withId(R.id.tagShopOnMap), withText("TAG On MAP"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction button3 = onView(
                allOf(withId(R.id.login_button), withText("Already have an account"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.activity_main),
                                        1),
